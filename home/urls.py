...
from .views import IndexView, register, mzalendo_list_view, mzalendo_create_view, MzalendoDetailView, quick_edit
from . import views
...
urlpatterns = [
    ...
    path('mzalendo/<slug:slug>/', MzalendoDetailView.as_view(), name='mzalendo_detail'),
    path(
